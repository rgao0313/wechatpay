...
import com.esg.user.uikit.CameraUtil;
import com.esg.user.uikit.MMAlert;
...
public class AddFavoriteToWXActivity extends Activity {
	...
	private void initView() {
				...
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						MMAlert.showAlert(AddFavoriteToWXActivity.this,
								...
								AddFavoriteToWXActivity.this.getResources()
								...
								null, new MMAlert.OnAlertSelectId() {
									...
									public void onClick(int whichButton) {
										...
										case MMAlertSelect2: {
											...
											if (!file.exists()) {
												String tip = AddFavoriteToWXActivity.this
		...
		findViewById(R.id.send_file).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						MMAlert.showAlert(
								...
								AddFavoriteToWXActivity.this.getResources()
										.getStringArray(R.array.send_file_item),
								null, new MMAlert.OnAlertSelectId() {
